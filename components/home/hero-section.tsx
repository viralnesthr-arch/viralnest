...
export function HeroSection() {
  ...
  // ✅ Optimized WhatsApp link (with pre-filled message)
  const whatsappLink =
    "https://wa.me/918802684249?text=Hi%20I%20am%20interested%20in%20your%20digital%20marketing%20services"
  ...
  return (
    <section
      aria-label="Digital Marketing Agency Hero Section - Viral Nest"
      className="relative"
    >
      <Vortex
      ...
      >
        <div className="mx-auto max-w-5xl px-6 py-32 text-center">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <Link
              href="/contact"
              aria-label="Book a free digital marketing consultation with Viral Nest"
            ...
            <a
              ...
              aria-label="Chat with Viral Nest on WhatsApp for digital marketing services"
